...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--quantize", choices=["none", "int8", "palettize4", "palettize6", "palettize8", "palettize4_int8lut"], default="none",
                   help="Post-training weight compression: none, int8, palettize4 (4-bit, 16 clusters), "
                        "palettize6 (6-bit, 64 clusters), palettize8 (8-bit, 256 clusters), "
                        "palettize4_int8lut (4-bit LUT + int8 quant, Apple W4A8)")
...
def _apply_compression(coreml_model, label: str, quantize: str):
    ...
    elif quantize == "palettize8":
        return _palettize(coreml_model, label, nbits=8)
